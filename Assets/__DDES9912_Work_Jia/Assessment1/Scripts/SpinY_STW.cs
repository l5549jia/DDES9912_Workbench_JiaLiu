...
public class SpinY_STW : MonoBehaviour
{
    public float ySpeed;
    public bool isActive = true;

    public float slowY = 60f;     // Slow rotation speed (deg/sec)
    public float normalY = 120f;  // Normal rotation speed
    public float fastY = 180f;    // Fast rotation speed
